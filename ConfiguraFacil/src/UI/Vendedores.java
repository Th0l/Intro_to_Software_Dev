...
public class Vendedores extends javax.swing.JFrame {
    ...
    public Vendedores(int id) {
        ...
        nome.setText("Bem-Vindo Sr." + bd.getNome(id,2));
    } 
    ...
    private void initComponents() {
        ...
        nome.setText("Bem-vindo, Sr xxxxx");
        ...
        Configurar.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_N, java.awt.event.InputEvent.CTRL_MASK));
        ...
        Ficheiro.add(Configurar);

        jMenuBar1.add(Ficheiro);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vendedores(Integer.parseInt(args[0])).setVisible(true);
            }
        });
    }
